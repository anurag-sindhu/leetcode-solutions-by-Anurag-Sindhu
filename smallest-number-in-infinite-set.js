...
SmallestInfiniteSet.prototype.popSmallest = function() {
	const smallestElement = this.heap.getMinimumElement().value;
	this.present[smallestElement] = false;
	this.heap.extractMinimumElement();
	return smallestElement;
};

SmallestInfiniteSet.prototype.addBack = function(num) {
	if (!this.present[num]) {
		this.heap.insertMinHeap(num);
...
values = [ [], [ 2 ], [], [], [], [ 1 ], [], [], [] ];
obj = new SmallestInfiniteSet(...values[0]);
