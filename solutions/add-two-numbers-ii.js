...
console.log(addTwoNumbers(singlyLinkedList([9, 9]).head, singlyLinkedList([9, 9]).head)); //1,0
console.log(addTwoNumbers(singlyLinkedList([8, 9, 9]).head, singlyLinkedList([2]).head)); //1,0
console.log(addTwoNumbers(singlyLinkedList([5]).head, singlyLinkedList([5]).head)); //1,0
console.log(addTwoNumbers(singlyLinkedList([1]).head, singlyLinkedList([9, 9]).head));
console.log(addTwoNumbers(singlyLinkedList([0]).head, singlyLinkedList([7, 3]).head));
console.log(addTwoNumbers(singlyLinkedList([7, 2, 4, 3]).head, singlyLinkedList([5, 6, 4]).head));
