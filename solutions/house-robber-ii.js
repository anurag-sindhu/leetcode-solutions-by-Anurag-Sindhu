...
var rob = function (nums) {
    ...
    const legacy = robLegacy(nums.slice(1, nums.length - 1 - 1));
    return Math.max(nums[nums.length - 1] + legacy[0], nums[0] + legacy[1]);
};
console.log(rob((nums = [1, 3, 1, 3, 100])) === 103);
console.log(rob((nums = [1, 2, 3, 1, 1, 2, 3, 1])) == 8);
