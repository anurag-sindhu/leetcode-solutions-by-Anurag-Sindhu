    ...
    for (const element of baseCosts) {
        ...
        if (temp1 === temp11) {
            if (temp1 < prevDiff) {
                ...
                prevDiff = temp1;
            } else if (prevDiff === temp1) {
                if (prevTarget > sortedKey[aa - 1] + element) {
                    prevTarget = sortedKey[aa - 1] + element;
                    prevDiff = temp1;
                }
            }
            ...
            if (temp1 < prevDiff) {
                ...
                if (prevTarget > sortedKey[aa] + element) {
                    prevTarget = sortedKey[aa] + element;
                    prevDiff = temp1;
                }
            }
...
console.log(
    closestCost((baseCosts = [9, 10, 1]), (toppingCosts = [1, 8, 8, 1, 1, 8]), (target = 8)) === 7,
);
console.log(
    closestCost(
        (baseCosts = [8, 4, 4, 5, 8]),
