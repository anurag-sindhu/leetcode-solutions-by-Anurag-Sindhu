...
let res;
res = findRedundantConnection((edges = [ [ 1, 2 ], [ 2, 3 ], [ 3, 4 ], [ 1, 4 ], [ 1, 5 ] ]));
console.log(areTwoArrayEqual(res, [ 1, 4 ]));

console.log(
	areTwoArrayEqual(
		findRedundantConnection((edges = [ [ 1, 4 ], [ 3, 4 ], [ 1, 3 ], [ 1, 2 ], [ 4, 5 ] ])),
		[ 1, 3 ]
	)
);
...
console.log(areTwoArrayEqual(findRedundantConnection([ [ 1, 2 ], [ 1, 3 ], [ 2, 3 ] ]), [ 2, 3 ])); //[2,3]
