...
var findWords = function (board, words) {
    ...
    function dfs(rowIndex, columnIndex, trieNode) {
        ...
        if (rowIndex > 0) {
            dfs(rowIndex - 1, columnIndex, nextNode);
        }
        if (rowIndex < rowCount - 1) {
            dfs(rowIndex + 1, columnIndex, nextNode);
        }
        if (columnIndex > 0) {
            dfs(rowIndex, columnIndex - 1, nextNode);
        }
    ...
    for (let rowIndex = 0; rowIndex < rowCount; rowIndex++) {
        for (let columnIndex = 0; columnIndex < columnCount; columnIndex++) {
            if (trie.root.children[board[rowIndex][columnIndex]]) {
                dfs(rowIndex, columnIndex, trie.root);
            }
        }
    }
...
console.log(resp); // ["oath","eat","hklf","hf"]
...
resp = findWords(
    ...
    (words = ['hklf', 'hf', 'oath', 'pea', 'eat', 'rain']),
);
console.log(resp); // ["oath","eat","hklf","hf"]
resp = findWords(
    (board = [
...
console.log(resp); // ["eat","oath"]
resp = findWords((board = [['a']]), (words = ['a']));
