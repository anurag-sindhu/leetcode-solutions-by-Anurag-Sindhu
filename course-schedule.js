var canFinish = function (numCourses, prerequisites) {
    ...
    function completingCourses(course, courseInProgress) {
        ...
        for (const iterator of courseMustBeCompleted[course]) {
            ...
            if (courseInProgress[iterator]) {
                return false;
            } else {
                courseInProgress[iterator] = true;
            }
    ...
    for (const key in courseMustBeCompleted) {
        const response = completingCourses(key, {});
        courseCompleted[key] = true;
        if (response === false) {
            return false;
        }
    }
